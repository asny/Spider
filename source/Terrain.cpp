...
void Terrain::set_height(double scale, int r, int c, std::vector<double> neighbour_heights)
{
...
void Terrain::subdivide(int origo_r, int origo_c, int size)
{
...
double Terrain::get_height_at(const vec3& position) const
{
